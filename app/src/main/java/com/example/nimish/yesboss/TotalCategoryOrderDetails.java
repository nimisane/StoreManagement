...
public class TotalCategoryOrderDetails extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.total_category_order);
...
//        });
    ...
    public void calculateTotal(final String category,String startDate,String endDate){
        allOrderRef.whereEqualTo("category",category).whereGreaterThanOrEqualTo("dateOnly",startDate).whereLessThanOrEqualTo("dateOnly",endDate)
                .get()
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        ...
                        totalOrder.setText("Total Order: "+String.valueOf(totalSum));
    ...
    protected void onStart() {
        ...
        calculateTotal(category,dateOnly,dateOnly);
       // calculateTotal(category,dateOnly);
    ...
    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
        ...
        Intent intent = getIntent();
        final String category = intent.getStringExtra(CATEGORY);
        calculateTotal(category,start_date,end_date);
        //calculateTotal(category,currentDate);
    }
